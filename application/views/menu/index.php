                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           <li class="breadcrumb-item"><a href="<?= base_url('menu/add_menu'); ?>" class="btn btn-primary mb-3"><i class="fas fa-plus mr-2"></i>New Menu</a></li>
                        </ol>
                     </div><!-- /.col -->
                  </div><!-- /.row -->
               </div><!-- /.container-fluid -->
                           ...
                           <tbody>
                              ...
                              <?php foreach ($menu as $m) : ?>
                                 <tr>
                                    ...
                                    <td><?= $m['icons']; ?></td>
                                    <td>
                                       <a href="<?= base_url(); ?>menu/edit_menu/<?= $m['id_menu']; ?>" class="btn btn-xs" style="background-color: #3c8dbc; color:white;"><i class="fas fa-edit mr-1"></i>Edit</a>
                                       <a href="<?= base_url(); ?>menu/hapus_menu/<?= $m['id_menu']; ?>" class="btn btn-xs button-delete" style="background-color: #ff851b;"><i class="fas fa-eraser mr-1"></i>Delete</a>
                                    </td>
                                 </tr>
                                 <?php $i++; ?>
                              <?php endforeach; ?>
